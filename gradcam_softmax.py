...
from models.py_utils.kp_utils import  _exct_decode, _h_aggregate, _v_aggregate, _nms
import tqdm
    ...
    def forward_pass_on_convolutions(self, x):
        ...
        for ind, layer in enumerate(layers):
            ...
            if ind == self.model.nstack - 1:
                ...
                t_heat = _nms(t_heat, kernel=3)
                l_heat = _nms(l_heat, kernel=3)
                b_heat = _nms(b_heat, kernel=3)
                r_heat = _nms(r_heat, kernel=3)
                # #======
...
if __name__ == '__main__':
    ...
    for ind_img in tqdm.tqdm(range(21,35)):
        ...
        for flag in ['l','r','b','t']:
            ...
            # Save mask
            file_name_to_export = "out_heatmap_{}_softmax/{:06d}_{}".format(flag, ind_img, flag)
